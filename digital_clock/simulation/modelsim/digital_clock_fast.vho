...
-- clock_out	=>  Location: PIN_V4,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- clock	=>  Location: PIN_M1,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default


ARCHITECTURE structure OF clock_divisor IS
...
-- Equation(s):
-- \count[22]~64_combout\ = count(22) $ (\count[21]~63\)
...
-- Equation(s):
-- \count[9]~38_combout\ = (count(9) & (\count[8]~37\ $ (GND))) # (!count(9) & (!\count[8]~37\ & VCC))
-- \count[9]~39\ = CARRY((count(9) & !\count[8]~37\))
...
-- Equation(s):
-- \count[10]~40_combout\ = (count(10) & (!\count[9]~39\)) # (!count(10) & ((\count[9]~39\) # (GND)))
-- \count[10]~41\ = CARRY((!\count[9]~39\) # (!count(10)))
...
-- Equation(s):
-- \count[11]~42_combout\ = (count(11) & (\count[10]~41\ $ (GND))) # (!count(11) & (!\count[10]~41\ & VCC))
-- \count[11]~43\ = CARRY((count(11) & !\count[10]~41\))
...
-- Equation(s):
-- \count[12]~44_combout\ = (count(12) & (!\count[11]~43\)) # (!count(12) & ((\count[11]~43\) # (GND)))
-- \count[12]~45\ = CARRY((!\count[11]~43\) # (!count(12)))
...
-- Equation(s):
-- \count[13]~46_combout\ = (count(13) & (\count[12]~45\ $ (GND))) # (!count(13) & (!\count[12]~45\ & VCC))
-- \count[13]~47\ = CARRY((count(13) & !\count[12]~45\))
...
-- Equation(s):
-- \count[16]~52_combout\ = (count(16) & (!\count[15]~51\)) # (!count(16) & ((\count[15]~51\) # (GND)))
-- \count[16]~53\ = CARRY((!\count[15]~51\) # (!count(16)))
...
-- Equation(s):
-- \count[19]~58_combout\ = (count(19) & (\count[18]~57\ $ (GND))) # (!count(19) & (!\count[18]~57\ & VCC))
-- \count[19]~59\ = CARRY((count(19) & !\count[18]~57\))
...
-- Equation(s):
-- \Equal0~6_combout\ = (count(22) & (!count(20) & !count(21)))
...
-- Equation(s):
-- \Equal0~2_combout\ = (count(9) & (count(11) & (count(8) & !count(10))))
